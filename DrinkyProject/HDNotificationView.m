...
#define IMAGE_VIEW_ICON_FRAME                   CGRectMake(10.0f, 8.0f, 45.0f, 45.0f)
#define LABEL_TITLE_FRAME                       CGRectMake(60.0f, 3.0f, [[UIScreen mainScreen] bounds].size.width - 45.0f, 26.0f)
#define LABEL_MESSAGE_FRAME_HEIGHT              35.0f
#define LABEL_MESSAGE_FRAME                     CGRectMake(60.0f, 25.0f, [[UIScreen mainScreen] bounds].size.width - 45.0f, LABEL_MESSAGE_FRAME_HEIGHT)
